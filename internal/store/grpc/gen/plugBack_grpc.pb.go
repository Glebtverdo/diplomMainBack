...
const (
	...
	PlugBackGrpc_GetWorkDayAddresses_FullMethodName = "/plugBackGrpc.PlugBackGrpc/GetWorkDayAddresses"
)
...
type PlugBackGrpcClient interface {
	...
	GetWorkDayAddresses(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*WorkDayAddresses, error)
}
...
func (c *plugBackGrpcClient) GetWorkDayAddresses(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*WorkDayAddresses, error) {
	out := new(WorkDayAddresses)
	err := c.cc.Invoke(ctx, PlugBackGrpc_GetWorkDayAddresses_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlugBackGrpcServer interface {
	...
	GetWorkDayAddresses(context.Context, *EmptyRequest) (*WorkDayAddresses, error)
...
func (UnimplementedPlugBackGrpcServer) GetWorkDayAddresses(context.Context, *EmptyRequest) (*WorkDayAddresses, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWorkDayAddresses not implemented")
}
...
func _PlugBackGrpc_GetWorkDayAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlugBackGrpcServer).GetWorkDayAddresses(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlugBackGrpc_GetWorkDayAddresses_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlugBackGrpcServer).GetWorkDayAddresses(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PlugBackGrpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWorkDayAddresses",
			Handler:    _PlugBackGrpc_GetWorkDayAddresses_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "plugBack.proto",
}
